...
#define FLASH_SIZE_GRANULARITY_BANK1    (1024  * 1024)
#define FLASH_SIZE_GRANULARITY_16K      (4*16  * 1024)
#define FLASH_SIZE_GRANULARITY_64K      (1*64  * 1024)
#define FLASH_SIZE_GRANULARITY_128K     (7*128 * 1024)

#define STM32_FLASH_START_ADRESS_BANK1  STM32_FLASH_START_ADRESS
#define STM32_FLASH_START_ADRESS_16K    (STM32_FLASH_START_ADRESS + (uint32_t)0x100000)
...
static int fal_flash_read_bank1(long offset, rt_uint8_t *buf, size_t size);
...
static int fal_flash_write_bank1(long offset, const rt_uint8_t *buf, size_t size);
...
static int fal_flash_erase_bank1(long offset, size_t size);
static int fal_flash_erase_16k(long offset, size_t size);
static int fal_flash_erase_64k(long offset, size_t size);
static int fal_flash_erase_128k(long offset, size_t size);

const struct fal_flash_dev stm32_onchip_flash_bank1 = { "onchip_flash_bank1", STM32_FLASH_START_ADRESS_BANK1, FLASH_SIZE_GRANULARITY_BANK1, (128 * 1024), {NULL, fal_flash_read_bank1, fal_flash_write_bank1, fal_flash_erase_bank1}, 8 };
const struct fal_flash_dev stm32_onchip_flash_16k = { "onchip_flash_16k", STM32_FLASH_START_ADRESS_16K, FLASH_SIZE_GRANULARITY_16K, (16 * 1024), {NULL, fal_flash_read_16k, fal_flash_write_16k, fal_flash_erase_16k}, 8 };
const struct fal_flash_dev stm32_onchip_flash_64k = { "onchip_flash_64k", STM32_FLASH_START_ADRESS_64K, FLASH_SIZE_GRANULARITY_64K, (64 * 1024), {NULL, fal_flash_read_64k, fal_flash_write_64k, fal_flash_erase_64k}, 8 };
const struct fal_flash_dev stm32_onchip_flash_128k = { "onchip_flash_128k", STM32_FLASH_START_ADRESS_128K, FLASH_SIZE_GRANULARITY_128K, (128 * 1024), {NULL, fal_flash_read_128k, fal_flash_write_128k, fal_flash_erase_128k}, 8 };

static int fal_flash_read_bank1(long offset, rt_uint8_t *buf, size_t size)
{
    return stm32_flash_read(stm32_onchip_flash_bank1.addr + offset, buf, size);
}
static int fal_flash_read_16k(long offset, rt_uint8_t *buf, size_t size)
{
...
static int fal_flash_write_bank1(long offset, const rt_uint8_t *buf, size_t size)
{
    return stm32_flash_write(stm32_onchip_flash_bank1.addr + offset, buf, size);
}
static int fal_flash_write_16k(long offset, const rt_uint8_t *buf, size_t size)
{
...
static int fal_flash_erase_bank1(long offset, size_t size)
{
    return stm32_flash_erase(stm32_onchip_flash_bank1.addr + offset, size);
}
static int fal_flash_erase_16k(long offset, size_t size)
{
